void keyPressed(){
  ...
  if (keyCode == ENTER && combat_choix == 1 && touche == false && menu_List == 3){playerMattaque = false; combat_tour();}
  else
  if (keyCode == ENTER && combat_choix == 2 && touche == false && menu_List == 3 && player_MP >= 5){player_MP = player_MP-5; playerMattaque = true; combat_tour();}
  else
  if (keyCode == ENTER && combat_choix == 3 && touche == false && menu_List == 3) player_fuite();
